...
import CategoryMenuComponent from './productsPageComponents/CategoryMenuComponent';
import SortMenuComponent from './productsPageComponents/SortMenuComponent';
import userUseProductsHook from './userUseProductsHook';
import EditProductForm from '../adminUtilities/editProductForm/EditProductForm';
  ...
  return (
    <div className='container'>
      <section>
        ...
        { categoryMenuOpen && <CategoryMenuComponent categoryMenuExiting={categoryMenuExiting} closeCategoryMenu={closeCategoryMenu} selectedCategory={selectedCategory} handleCategorySelect={handleCategorySelect} categories={categories} /> }

        { sortMenuOpen && <SortMenuComponent sortMenuExiting={sortMenuExiting} closeSortMenu={closeSortMenu} sortOptions={sortOptions} selectedSort={selectedSort} handleSortSelect={handleSortSelect} /> }

        {showPaginationButtons && (
          <div className="text-muted container" style={{ display: "flex", justifyContent: "space-between", margin: "1rem 0" }}>
                  ...
                  >
                    <div className="product-image-cover position-relative">
                      ...
                      >
                        ...
                        >
                          {isAdmin ? <span><i className="fa-solid fa-trash mx-2"></i> Delete</span> : (isAnyVariantInCart(product.id) ? "View in cart" : "Add to Cart")}
                        </button>
                      </div>
