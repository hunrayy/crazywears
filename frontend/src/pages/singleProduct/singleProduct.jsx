...
import { newTestHook } from "./newTestHook"
import { useTestHook } from "../test/useTestHook";
...
//   const { test } = newTestHook(productId)
//   console.log(test)
//   useEffect(() => {
//     console.log("✅ SingleProduct mounted");

//     return () => {
//       console.log("❌ SingleProduct unmounted");
//     };
//   }, []);
...
//   const [selectedImage, setSelectedImage] = useState(""); // State for the enlarged image
  ...
  const handleAddToCart = () => {
    ...
    console.log("product.productPricesArray:", product?.productPricesArray);
    console.log("product.productPrices:", product?.productPrices);

    addToCart(product, variant);
    // addToCart(product, variant, productSizes, productPrices);
  };

  // const prices = product.productPrices == "string" ? JSON.parse(product.productPrices) : product.productPrices;
  // const prices = productPrices
  const prices = product?.productPricesArray;
 ...
 console.log(prices)
  console.log(product)
  console.log("About to calculate smallestPrice");
...
//   // console.log(smallestPrice); // 80000
  ...
  console.log("subMedia:", product.subMedia);
  console.log("Array?", Array.isArray(product.subMedia));
  console.log("typeof:", typeof product.subMedia);
  const productImages = [
...
//   const currencySymbol = currencySymbols[selectedCurrency] || '';
//   console.log(product.subMedia);
//   console.log(typeof product.subMedia);
//   const productImages = [
//     product.mainProductMedia,
//     ...product.subMedia
//     // ...(product.subImage1 ? [product.subImage1] : []),
